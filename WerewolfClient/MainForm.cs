...
namespace WerewolfClient
{
    public partial class MainForm : Form, View
    {
            ...
            if (m is WerewolfModel)
            {
                ...
                switch (wm.Event)
                {
                    case EventEnum.JoinGame:
                        ...
                        {
                            this.Visible = false;
                            MessageBox.Show("Please Login Your Username Again.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void GameFnish_Paint(object sender, PaintEventArgs e)
        {
